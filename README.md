...
A self hosted server (one Docker container) you can run 24/7 so your context files sync between KOReader devices and you can browse and edit them in a browser. Keep it on your LAN, or expose it to the internet at your own risk (a Cloudflare tunnel is an easy, port forwarding free option, Tailscale is another, only open firewall ports if you know what you are doing).
